...
2. Run the script [./src/utils/download_data.py](./src/utils/download_data.py). This script downloads the drug descriptors, the RNA-Seq expressions, and the drug responses for the data as described below. 
